          ...
          >
            <div class="grid gap-5 sm:grid-cols-2">
              ...
              <div class="grid gap-2">
                ...
                <Select
                  name="is_active"
                  :default-value="tenant?.is_active === false ? '0' : '1'"
                >
            ...
            <div class="grid gap-5 sm:grid-cols-2">
              <div class="sm:col-span-2">
                ...
                <p class="text-sm text-muted-foreground">
                  These credentials are created inside the new tenant database.
                </p>
              </div>
              ...
              <div class="grid gap-2">
                <Label for="tenant-admin-password"> Temporary password </Label>
                <Input
