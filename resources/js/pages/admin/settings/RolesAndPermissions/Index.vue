                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <SheetDescription>
                                    Add a web role and choose the permissions it
                                    should receive.
                                </SheetDescription>
                            </SheetHeader>
                            ...
                            >
                                ...
                                <fieldset class="grid gap-3">
                                    <div class="space-y-1">
                                        ...
                                        >
                                            Select the abilities available to
                                            this role.
                                        </p>
                                    </div>
                                    ...
                                    <p
                                        ...
                                        class="rounded-lg border border-dashed border-border px-4 py-6 text-center text-sm text-muted-foreground"
                                    >
                                        No web permissions are available yet.
                                    </p>
                                    <InputError
                                        :message="
                                            errors.permissions ||
                    ...
                    <div class="flex-1 space-y-6 overflow-y-auto px-6 py-5">
                        ...
                        <fieldset class="grid gap-3">
                            ...
                            <p
                                ...
                                class="rounded-lg border border-dashed border-border px-4 py-6 text-center text-sm text-muted-foreground"
                            >
                                No {{ activePermissionGuard }} permissions are
                                available yet.
                            </p>
                            <InputError
                                :message="
